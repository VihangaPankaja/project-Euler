...
def lex_permu(sel_nums: list[int] = []):   # or use permutations module in itertolls library
    """ returns list of lexicographic permutation for a given iterable """
    global count, digits, stop, number
    
    rem_dig: list[int] = list(i for i in digits if i not in sel_nums)  # list of digits remaing after previous selections
